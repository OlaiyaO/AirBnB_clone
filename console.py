...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, line):
        """ Display command to show an instance based on class name and id """
        if not line:
            print("** class name missing **")
    ...
    def do_all(self, line):
        """All command to print instances based or not class name"""
        str_list = []
    ...
    def do_update(self, line):
        """Update command to update instance base on class name and id"""
        splitline = split(line)
